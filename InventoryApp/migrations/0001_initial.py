    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categories', to='InventoryApp.category')),
                ('suppliers', models.ManyToManyField(related_name='products', to='InventoryApp.supplier')),
            ],
        ),
        migrations.CreateModel(
            name='Warehouse',
